...
class TestDataProject(unittest.TestCase):
    ...
    def test_get_extra_runs_per_team(self):
        returned_value = file4.get_economy_of_each_bowler_for_2015('data_project_tests', 'matches_test_data','deliveries_test_data')
        expected_value = {'TG Southee': 12.0}
        self.assertEqual(returned_value,expected_value)
        file4.plot_graph('data_project_tests','matches_test_data','deliveries_test_data')
